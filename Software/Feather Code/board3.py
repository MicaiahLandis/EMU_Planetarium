# Feather Board 3 (Axis 3: Azimuth)
...
ir = digitalio.DigitalInOut(board.SCL)
...
def calibrate(direction, speed, var):
    ...
    calibrated = True
    position = 0
    msg = Message(id=0x100, data=bytes([0]), extended=False)
    can.send(msg)

# Move to specified coordinate [0,360)
